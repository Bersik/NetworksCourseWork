...
public class AcceptConnectionVirtualConnPacket extends AcceptPacket {
     ...
     */
    public AcceptConnectionVirtualConnPacket(Node from, Node to, Link link, int idOriginalPacket, int virtualConnectionID) {
